...
public class GUI_Empleado extends JFrame implements ActionListener {
	...
	public GUI_Empleado() {
		...
		JLabel label_cedula = new JLabel("");
		label_cedula.setBounds(239, 42, 46, 14);
		contentPane.add(label_cedula);
	}

	@Override
	public void actionPerformed(ActionEvent e) {
		
		if (this.validadorDeCedula(this.txt_cedula.getText())) {
